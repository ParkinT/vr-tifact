...
public class JointOrientation : MonoBehaviour
{
    ...
    {
        if (GameObject.Find("Joint").renderer.bounds.Intersects(targetObject.renderer.bounds))
        {
            targetObject.gameObject.transform.position = this.gameObject.transform.position;
            isHoldingObj = true;
